...
//System.out.println(highestfreqchar("qwertyuioplkjhgffff"));
		...
		Hman k = new Hman("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaabbbbbbbbbccd");
		System.out.println(k.encode("ababcdcd"));
		System.out.println(k.decode("101101001000001000"));
		
	
		Huffmann h = new Huffmann("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaabbbbbbbbbccd");
		
		System.out.println(h.encode("ababcdcd"));
		System.out.println(h.decode("101101001000001000"));
