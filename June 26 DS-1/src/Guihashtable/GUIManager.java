...
public class GUIManager extends JFrame implements ActionListener {
	...
	JButton btnGet, btnPut, btnRemove , btnabout;
//	JMenuBar menu ;
	HashTable<String, String> map;

	public GUIManager() {
		super.setTitle("HashTable Graphic Demo BETA");
		super.setSize(1096, 983); //2048, 1080
...
//		top = new JPanel();
//		left.setSize(1400, 240);
//		super.add(top);
//		
		
		left = new JPanel();
		left.setSize(1400, 240);//2048, 240
		super.add(left);

		divideLeft();

		right = new JPanel();
		right.setSize(2050, 840);//2048, 840
		super.add(right);
	}
